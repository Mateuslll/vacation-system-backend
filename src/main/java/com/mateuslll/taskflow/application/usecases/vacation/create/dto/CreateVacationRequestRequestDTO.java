package com.mateuslll.taskflow.application.usecases.vacation.create.dto;
...
public record CreateVacationRequestRequestDTO(
        ...
        @Schema(type = "string", format = "date", example = "2026-05-14")
        @JsonFormat(pattern = "yyyy-MM-dd")
